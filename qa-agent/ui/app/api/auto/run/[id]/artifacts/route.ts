...
export async function GET(
  ...
  try {
    ...
    console.log('[GET /api/auto/run/artifacts]', { id });
    
    const response = await proxyToBackend(`/auto/run/${id}/artifacts`);
    ...
    console.error('[GET /api/auto/run/artifacts] Error:', error);
